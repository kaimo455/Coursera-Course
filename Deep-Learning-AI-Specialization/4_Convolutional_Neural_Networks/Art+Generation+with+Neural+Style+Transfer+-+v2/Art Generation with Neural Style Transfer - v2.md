...
```
    ...
    <matplotlib.image.AxesImage at 0x7fdd2be9b5f8>
...
def compute_content_cost(a_C, a_G):
    ...
    a_C_unrolled = tf.transpose(tf.reshape(a_C, shape=(n_H*n_W, n_C)), perm=[1, 0])
...
```
    ...
    <matplotlib.image.AxesImage at 0x7fdd1c789eb8>
...
```
    ...
    <matplotlib.image.AxesImage at 0x7fdd09fea320>
