...
def identity_block(X, f, filters, stage, block):
    ...
    # First component of main path
    X = Conv2D(filters = F1, kernel_size = (1, 1), strides = (1,1), name = conv_name_base + '2a', kernel_initializer = glorot_uniform(seed=0))(X)
...
```
    ...
    Epoch 1/2
    1080/1080 [==============================] - 229s - loss: 2.9132 - acc: 0.2713   
    Epoch 2/2
    1080/1080 [==============================] - 225s - loss: 2.1609 - acc: 0.3806   





    <keras.callbacks.History at 0x7f076373ce10>
