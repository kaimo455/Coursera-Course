 ...
 */
 class ListsSuite {
  ...
  @Test def `sum of a few numbers (10pts)`: Unit = {
    ...
    assert(sum(List(-100, 50, 28)) == -22)
    assert(sum(List(-4, 5, 0, 8)) == 9)
    assert(sum(List(-4, 5, 5, 8)) == 14)
  }

  @Test def `max of a few numbers (10pts)`: Unit = {
    assert(max(List(3, 7, 2)) == 7)
    assert(max(List(-3, 10, 6, 9)) == 10)
    assert(max(List(0, 56, -12)) == 56)
    assert(max(List(1,1,1,1,1)) == 1)
  }
